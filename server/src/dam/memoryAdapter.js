...
export function createMemoryAdapter() {
  ...
  return {
    async init() {
      ...
      seedPatient({ ...base, id: 'P-24071', bloodGroup: 'B+', height: 170, foodAllergies: [], abha: '91-4523-8871-2210', name: 'Ramesh Patel', mobile: '9800000001', age: 54, sex: 'M', dept: 'General Medicine', complaint: 'Chest discomfort, breathlessness on exertion (3 days)', allergies: ['Penicillin'], conditions: ['Type 2 Diabetes (2016)', 'Hypertension (2019)'], bp: '148/94', pulse: 96, temp: 99.1, spo2: 94, rr: 20, weight: 78, lastVisit: '02 Jun 2026', meds: ['Metformin 500 mg BD', 'Telmisartan 40 mg OD'] });
      seedPatient({ ...base, id: 'P-24072', bloodGroup: 'O+', height: 158, foodAllergies: [], abha: '91-8810-2245-9034', name: 'Sunita Devi', mobile: '9800000002', age: 32, sex: 'F', dept: 'Obstetrics', complaint: 'ANC check-up, 28 weeks, mild pedal edema', conditions: ['G2P1 · 28 wks'], bp: '118/76', pulse: 84, temp: 98.4, spo2: 98, rr: 16, weight: 64, lastVisit: '20 Jun 2026', meds: ['IFA tablets OD', 'Calcium 500 mg OD'] });
      seedPatient({ ...base, id: 'P-24073', bloodGroup: 'A+', height: 128, foodAllergies: ['Peanuts'], abha: '91-3312-7789-4456', name: 'Arjun Malhotra', mobile: '9800000003', age: 8, sex: 'M', dept: 'General Medicine', complaint: 'High fever with rash, 2 days', bp: '100/64', pulse: 110, temp: 102.3, spo2: 97, rr: 24, weight: 24 });
      seedPatient({ ...base, id: 'P-24074', bloodGroup: 'AB+', height: 155, foodAllergies: [], abha: '91-9902-1123-8867', name: 'Fatima Begum', mobile: '9800000004', age: 61, sex: 'F', dept: 'Orthopedics', complaint: 'Left knee pain, difficulty climbing stairs', allergies: ['Sulfa drugs'], conditions: ['Osteoarthritis (2021)'], bp: '132/86', pulse: 78, temp: 98.2, spo2: 97, rr: 16, weight: 70, lastVisit: '11 May 2026', meds: ['Glucosamine OD'] });
      seedPatient({ ...base, id: 'P-24075', bloodGroup: 'B+', height: 172, foodAllergies: [], abha: '91-5567-3390-1272', name: 'Mohan Lal', mobile: '9800000005', age: 45, sex: 'M', dept: 'General Medicine', complaint: 'Follow-up: fatty liver, deranged LFT', conditions: ['NAFLD (2024)'], bp: '126/82', pulse: 74, temp: 98.6, spo2: 98, rr: 15, weight: 88, lastVisit: '28 May 2026', meds: ['Ursodeoxycholic acid 300 BD'] });
      seedPatient({ ...base, id: 'P-24076', bloodGroup: 'O-', height: 162, foodAllergies: [], abha: '91-2231-9987-3345', name: 'Kavita Sharma', mobile: '9800000006', age: 27, sex: 'F', dept: 'ENT', complaint: 'Recurrent sore throat and ear fullness', bp: '112/74', pulse: 80, temp: 99.0, spo2: 99, rr: 15, weight: 55 });
